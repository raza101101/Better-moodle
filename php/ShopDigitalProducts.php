...
// Fetch digital products from the database
$stmt = $conn->prepare("SELECT id, name, price, image_path FROM products WHERE type = 'digital'");
$stmt->execute();
$result = $stmt->get_result();
$digitalProducts = $result->fetch_all(MYSQLI_ASSOC);
$stmt->close();
...
<html lang="en">
    <head>
        ...
        <title>Harzarian - Digital Products</title>
    ...
    <body>
        ...
        <main>
            <h1 class="page-title">Digital Products</h1>
